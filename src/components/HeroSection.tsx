...
const HeroSection = () => {
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-16">
      ...
      <div className="absolute top-20 right-10 h-64 w-64 bg-primary/10 rounded-full blur-3xl" />
      <div className="absolute bottom-20 left-10 h-64 w-64 bg-portfolio-purple/10 rounded-full blur-3xl" />
      ...
      <div className="max-container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="relative w-full h-[400px] lg:h-[500px] p-4">
          ...
          <div className="absolute inset-4 glassmorphism rounded-lg flex items-center justify-center p-8">
            <div className="relative w-full h-full bg-white/10 dark:bg-white/5 rounded-md border border-white/20 backdrop-blur-sm p-4 overflow-hidden">
              ...
              <div className="mt-5 space-y-2">
                ...
                <div className="h-12 mt-4 bg-white/10 dark:bg-white/5 rounded-md border border-white/20 dark:border-white/10"></div>
                <div className="flex gap-2 mt-4">
                  <div className="h-4 bg-portfolio-purple/30 dark:bg-portfolio-purple/20 rounded w-1/3"></div>
                  <div className="h-4 bg-portfolio-blue/30 dark:bg-portfolio-blue/20 rounded w-1/3"></div>
                </div>
                <div className="h-4 bg-white/20 dark:bg-white/10 rounded w-5/6"></div>
                <div className="h-4 bg-white/20 dark:bg-white/10 rounded w-4/5"></div>
